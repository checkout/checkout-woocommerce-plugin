...
/**
 * Class WC_Gateway_Uprise_Payment_Alternative_Payments_Ideal
 *
 * @class   WC_Gateway_Uprise_Payment_Alternative_Payments_Ideal
 * @extends WC_Gateway_Uprise_Payment_Alternative_Payments
 */
class WC_Gateway_Uprise_Payment_Alternative_Payments_Ideal extends WC_Gateway_Uprise_Payment_Alternative_Payments {
	...
	public function __construct() {
		$this->id                 = 'wc_uprise_payment_alternative_payments_ideal';
		...
		$this->title              = __( 'Ideal', 'uprise-payment-woocommerce' );
	...
	public function payment_fields() {
		...
		if ( ! in_array( self::PAYMENT_METHOD, $apm_available, true ) ) {
			?>
				<script>
					jQuery('.payment_method_wc_uprise_payment_alternative_payments_ideal').hide();
				</script>
			<?php
		} else {
