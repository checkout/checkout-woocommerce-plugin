<?php
/**
 * Bancontact APM class.
 *
 * @package wc_uprise_payment
 */

/**
 * Class WC_Gateway_Uprise_Payment_Alternative_Payments_Bancontact
 *
 * @class   WC_Gateway_Uprise_Payment_Alternative_Payments_Bancontact
 * @extends WC_Gateway_Uprise_Payment_Alternative_Payments
 */
class WC_Gateway_Uprise_Payment_Alternative_Payments_Bancontact extends WC_Gateway_Uprise_Payment_Alternative_Payments {
	...
	public function __construct() {
		$this->id         = 'wc_uprise_payment_alternative_payments_bancontact';
		$this->title      = __( 'Bancontact', 'uprise-payment-woocommerce' );
	...
	public function payment_fields() {
		...
		$message       = __( 'Pay with Bancontact. You will be redirected upon place order', 'uprise-payment-woocommerce' );
		...
		if ( ! in_array( self::PAYMENT_METHOD, $apm_available, true ) ) {
			?>
				<script>
					jQuery('.payment_method_wc_uprise_payment_alternative_payments_bancontact').hide();
				</script>
			<?php
		}
