...
/**
 * Class WC_Gateway_Uprise_Payment_Alternative_Payments_Boleto
 *
 * @class   WC_Gateway_Uprise_Payment_Alternative_Payments_Boleto
 * @extends WC_Gateway_Uprise_Payment_Alternative_Payments
 */
class WC_Gateway_Uprise_Payment_Alternative_Payments_Boleto extends WC_Gateway_Uprise_Payment_Alternative_Payments {
	...
	public function __construct() {
		$this->id                 = 'wc_uprise_payment_alternative_payments_boleto';
		$this->method_title       = __( 'Uprise Payment', 'uprise-payment-woocommerce' );
		$this->method_description = __( 'UPrise payment extension allows shop owners to process online payments through the <a href="https://uprisepay.com">Uprise Payment.</a>', 'uprise-payment-woocommerce' );
		$this->title              = __( 'Boleto', 'uprise-payment-woocommerce' );
	...
	public function payment_fields() {
		...
		if ( ! in_array( self::PAYMENT_METHOD, $apm_available, true ) ) {
			?>
				<script>
					jQuery('.payment_method_wc_uprise_payment_alternative_payments_boleto').hide();
				</script>
			<?php
		} else {
			...
			?>
				...
				jQuery('#place_order').click(function(e) {
					...
					if (jQuery('#payment_method_wc_uprise_payment_alternative_payments_boleto').is(':checked')) {
