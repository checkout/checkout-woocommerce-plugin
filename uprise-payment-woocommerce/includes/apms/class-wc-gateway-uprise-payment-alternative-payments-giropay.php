...
/**
 * Class WC_Gateway_Uprise_Payment_Alternative_Payments_Giropay
 *
 * @class   WC_Gateway_Uprise_Payment_Alternative_Payments_Giropay
 * @extends WC_Gateway_Uprise_Payment_Alternative_Payments
 */
class WC_Gateway_Uprise_Payment_Alternative_Payments_Giropay extends WC_Gateway_Uprise_Payment_Alternative_Payments {
	...
	public function __construct() {
		$this->id         = 'wc_uprise_payment_alternative_payments_giropay';
		$this->title      = __( 'Giropay', 'uprise-payment-woocommerce' );
	...
	public function payment_fields() {
		...
		$message       = __( 'Pay with Giropay. You will be redirected upon place order', 'uprise-payment-woocommerce' );
		...
		if ( ! in_array( self::PAYMENT_METHOD, $apm_available, true ) ) {
			?>
				<script>
					jQuery('.payment_method_wc_uprise_payment_alternative_payments_giropay').hide();
				</script>
			<?php
		}
