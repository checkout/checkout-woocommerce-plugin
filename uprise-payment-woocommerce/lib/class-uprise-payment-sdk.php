...
include_once dirname( __DIR__ ) . '/includes/api/class-wc-uprisepay-utility.php';
...
class Checkout_SDK {
	...
	public function __construct() {
		...
		$environment   = 'sandbox' === $core_settings['upycom_environment'] ? Environment::sandbox() : Environment::production();

		$this->nas_account_type = upy_is_nas_account();
		...
		$builder->setPublicKey( $core_settings['upycom_pk'] );
		$builder->setSecretKey( $core_settings['upycom_sk'] );
