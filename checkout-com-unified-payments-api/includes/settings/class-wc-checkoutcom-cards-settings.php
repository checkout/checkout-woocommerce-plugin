...
class WC_Checkoutcom_Cards_Settings {
	...
	public static function flow_settings() {
		...
		$settings = array_merge(
			...
			'flow_payment_label_settings'          => array(
				'title'       => __( 'Payment Method Label Styling', 'checkout-com-unified-payments-api' ),
				'type'        => 'title',
				'description' => __( 'Customize the appearance of the payment method label on checkout page. Defaults match standard WooCommerce appearance (transparent background, no border, icon on right).', 'checkout-com-unified-payments-api' ),
			),
			'flow_payment_label_background'       => array(
				'id'          => 'flow_payment_label_background',
				'title'       => __( 'Label Background Color', 'checkout-com-unified-payments-api' ),
				'type'        => 'color',
				'description' => __( 'Background color for payment method label. Use "transparent" or leave empty for transparent background (matches standard WooCommerce).', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => 'transparent',
			),
			'flow_payment_label_border_color'     => array(
				'id'          => 'flow_payment_label_border_color',
				'title'       => __( 'Label Border Color', 'checkout-com-unified-payments-api' ),
				'type'        => 'color',
				'description' => __( 'Border color for payment method label. Leave empty for no border (matches standard WooCommerce).', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => '',
			),
			'flow_payment_label_border_width'     => array(
				'id'          => 'flow_payment_label_border_width',
				'title'       => __( 'Label Border Width', 'checkout-com-unified-payments-api' ),
				'type'        => 'text',
				'description' => __( 'Border width (e.g., "0px", "1px", "2px"). Set to "0px" for no border (matches standard WooCommerce).', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => '0px',
			),
			'flow_payment_label_border_radius'    => array(
				'id'          => 'flow_payment_label_border_radius',
				'title'       => __( 'Label Border Radius', 'checkout-com-unified-payments-api' ),
				'type'        => 'text',
				'description' => __( 'Border radius (e.g., "0px", "4px", "8px"). Set to "0px" for no rounded corners (matches standard WooCommerce).', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => '0px',
			),
			'flow_payment_label_icon_position'     => array(
				'id'          => 'flow_payment_label_icon_position',
				'title'       => __( 'Icon Position', 'checkout-com-unified-payments-api' ),
				'type'        => 'select',
				'options'     => array(
					'right' => __( 'Right (matches standard WooCommerce)', 'checkout-com-unified-payments-api' ),
					'left'  => __( 'Left', 'checkout-com-unified-payments-api' ),
					'none'  => __( 'Hide Icon', 'checkout-com-unified-payments-api' ),
				),
				'description' => __( 'Position of payment method icon. Right matches standard WooCommerce and other payment providers.', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => 'right',
			),
			'flow_payment_label_text_color'        => array(
				'id'          => 'flow_payment_label_text_color',
				'title'       => __( 'Label Text Color', 'checkout-com-unified-payments-api' ),
				'type'        => 'color',
				'description' => __( 'Text color for payment method label title. Leave empty to inherit from theme (matches standard WooCommerce).', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => '',
			),
			'flow_payment_label_subtitle_color'    => array(
				'id'          => 'flow_payment_label_subtitle_color',
				'title'       => __( 'Label Subtitle Color', 'checkout-com-unified-payments-api' ),
				'type'        => 'color',
				'description' => __( 'Text color for payment method label subtitle. Leave empty to inherit from theme (matches standard WooCommerce).', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => '',
			),
			'flow_payment_label_text_align'        => array(
				'id'          => 'flow_payment_label_text_align',
				'title'       => __( 'Label Text Alignment', 'checkout-com-unified-payments-api' ),
				'type'        => 'select',
				'options'     => array(
					'left'   => __( 'Left (matches standard WooCommerce)', 'checkout-com-unified-payments-api' ),
					'center' => __( 'Center', 'checkout-com-unified-payments-api' ),
					'right'  => __( 'Right', 'checkout-com-unified-payments-api' ),
				),
				'description' => __( 'Text alignment for payment method label. Left matches standard WooCommerce and other payment providers.', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => 'left',
			),
			'flow_debug_settings'                   => array(
				'title'       => __( 'Debug Settings', 'checkout-com-unified-payments-api' ),
				'type'        => 'title',
				'description' => '',
			),
			'flow_file_logging'                     => array(
				'id'          => 'flow_file_logging',
				'title'       => __( 'File Logging', 'checkout-com-unified-payments-api' ),
				'type'        => 'checkbox',
				'label'       => __( 'Check to enable file logging', 'checkout-com-unified-payments-api' ),
				'description' => __( 'Enable file logging to write debug information to log files.', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => 'no',
			),
			'flow_console_logging'                  => array(
				'id'          => 'flow_console_logging',
				'title'       => __( 'Console Logging', 'checkout-com-unified-payments-api' ),
				'type'        => 'checkbox',
				'label'       => __( 'Check to enable console logging', 'checkout-com-unified-payments-api' ),
				'description' => __( 'Enable console logging to display debug information in browser console.', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => 'no',
			),
			'flow_gateway_responses'                => array(
				'id'          => 'flow_gateway_responses',
				'title'       => __( 'Gateway Responses', 'checkout-com-unified-payments-api' ),
				'type'        => 'checkbox',
				'label'       => __( 'Check to show gateway response', 'checkout-com-unified-payments-api' ),
				'description' => __( 'Enable to display gateway API responses in logs.', 'checkout-com-unified-payments-api' ),
				'desc_tip'    => true,
				'default'     => 'no',
			),
