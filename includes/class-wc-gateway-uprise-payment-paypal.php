...
/**
 * Class WC_Gateway_Uprise_Payment_PayPal for PayPal payment method.
 */
class WC_Gateway_Uprise_Payment_PayPal extends WC_Payment_Gateway {

	/**
	 * WC_Gateway_Uprise_Payment_PayPal constructor.
	 */
	public function __construct() {
		$this->id                 = 'wc_uprise_payment_paypal';
		...
		$this->title              = __( 'PayPal', 'uprise-payment-woocommerce' );
