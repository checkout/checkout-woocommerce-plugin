...
/**
 * Class WC_Gateway_Checkout_Com_Alternative_Payments_Sofort
 *
 * @class   WC_Gateway_Checkout_Com_Alternative_Payments_Sofort
...
class WC_Gateway_Checkout_Com_Alternative_Payments_Sofort extends WC_Gateway_Checkout_Com_Alternative_Payments {
	...
	public function __construct() {
		...
		$this->title      = __( 'Sofort', 'checkout-com-unified-payments-api' );
	...
	public function payment_fields() {
		...
		$message       = __( 'Pay with Sofort. You will be redirected upon place order', 'checkout-com-unified-payments-api' );
