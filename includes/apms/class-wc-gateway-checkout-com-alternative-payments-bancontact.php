...
/**
 * Class WC_Gateway_Checkout_Com_Alternative_Payments_Bancontact
 *
 * @class   WC_Gateway_Checkout_Com_Alternative_Payments_Bancontact
...
class WC_Gateway_Checkout_Com_Alternative_Payments_Bancontact extends WC_Gateway_Checkout_Com_Alternative_Payments {
	...
	public function __construct() {
		...
		$this->title      = __( 'Bancontact', 'checkout-com-unified-payments-api' );
	...
	public function payment_fields() {
		...
		$message       = __( 'Pay with Bancontact. You will be redirected upon place order', 'checkout-com-unified-payments-api' );
