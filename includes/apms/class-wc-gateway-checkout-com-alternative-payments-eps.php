...
/**
 * Class WC_Gateway_Checkout_Com_Alternative_Payments_Eps
 *
 * @class   WC_Gateway_Checkout_Com_Alternative_Payments_Eps
...
class WC_Gateway_Checkout_Com_Alternative_Payments_Eps extends WC_Gateway_Checkout_Com_Alternative_Payments {
	...
	public function __construct() {
		...
		$this->title      = __( 'EPS', 'checkout-com-unified-payments-api' );
	...
	public function payment_fields() {
		...
		$message       = __( 'Pay with EPS. You will be redirected upon place order', 'checkout-com-unified-payments-api' );
