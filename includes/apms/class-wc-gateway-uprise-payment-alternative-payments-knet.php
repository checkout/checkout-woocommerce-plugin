...
/**
 * Class WC_Gateway_Uprise_Payment_Alternative_Payments_Knet
 *
 * @class   WC_Gateway_Uprise_Payment_Alternative_Payments_Knet
 * @extends WC_Gateway_Uprise_Payment_Alternative_Payments
 */
class WC_Gateway_Uprise_Payment_Alternative_Payments_Knet extends WC_Gateway_Uprise_Payment_Alternative_Payments {
	...
	public function __construct() {
		$this->id         = 'wc_uprise_payment_alternative_payments_knet';
		$this->title      = __( 'KNET', 'uprise-payment-woocommerce' );
	...
	public function payment_fields() {
		...
		$message       = __( 'Pay with Knet. You will be redirected upon place order', 'uprise-payment-woocommerce' );
		...
		if ( ! in_array( self::PAYMENT_METHOD, $apm_available, true ) ) {
			?>
				<script>
					jQuery('.payment_method_wc_uprise_payment_alternative_payments_knet').hide();
				</script>
			<?php
		}
