...
use CheckoutComWC\Vendor\GuzzleHttp\Exception\BadResponseException;
use CheckoutComWC\Vendor\GuzzleHttp\Exception\RequestException;
use CheckoutComWC\Vendor\GuzzleHttp\Exception\TooManyRedirectsException;
...
class RedirectMiddleware
{
    ...
    public function checkRedirect(RequestInterface $request, array $options, ResponseInterface $response)
    {
        ...
        if (\CheckoutComWC\Vendor\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $nextRequest->getUri()) && defined('\CURLOPT_HTTPAUTH')) {
    ...
    public function modifyRequest(RequestInterface $request, array $options, ResponseInterface $response): RequestInterface
    {
        ...
        if (!isset($modify['body'])) {
            try {
                \CheckoutComWC\Vendor\GuzzleHttp\Psr7\Message::rewindBody($request);
        ...
        if (\CheckoutComWC\Vendor\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $modify['uri'])) {
            $modify['remove_headers'][] = 'Authorization';
            $modify['remove_headers'][] = 'Cookie';
        }
        return \CheckoutComWC\Vendor\GuzzleHttp\Psr7\Utils::modifyRequest($request, $modify);
    }
    /**
    ...
    {
        $location = \CheckoutComWC\Vendor\GuzzleHttp\Psr7\UriResolver::resolve($request->getUri(), new Psr7\Uri($response->getHeaderLine('Location')));
