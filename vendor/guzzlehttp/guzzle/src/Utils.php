...
use CheckoutComWC\Vendor\GuzzleHttp\Handler\CurlHandler;
use CheckoutComWC\Vendor\GuzzleHttp\Handler\CurlMultiHandler;
use CheckoutComWC\Vendor\GuzzleHttp\Handler\CurlShareHandleState;
use CheckoutComWC\Vendor\GuzzleHttp\Handler\CurlVersion;
use CheckoutComWC\Vendor\GuzzleHttp\Handler\Proxy;
use CheckoutComWC\Vendor\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    {
        checkoutcomwc_vendor_trigger_deprecation('guzzlehttp/guzzle', '7.12', '%s() is deprecated and will be removed in 8.0. Use get_debug_type() instead.', __METHOD__);
    ...
    public static function debugResource($value = null)
    {
        ...
        return \CheckoutComWC\Vendor\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
    ...
    {
        checkoutcomwc_vendor_trigger_deprecation('guzzlehttp/guzzle', '7.1', '%s() is deprecated and will be removed in 8.0. This method is not needed in PHP 5.6+.', __METHOD__);
        static $cached = null;
        static $cafiles = [
    ...
    public static function normalizeHeaderKeys(array $headers): array
    {
        ...
        foreach (\array_keys($headers) as $key) {
            $result[\CheckoutComWC\Vendor\GuzzleHttp\Psr7\Utils::asciiToLower((string) $key)] = $key;
        }
        return $result;
    }
    /**
    ...
    private static function parseNoProxyHost(string $host, ?int $port, bool $matchesRoot): ?array
    {
        ...
        return ['type' => 'domain', 'value' => \CheckoutComWC\Vendor\GuzzleHttp\Psr7\Utils::asciiToLower($host), 'port' => $port, 'matchesRoot' => $matchesRoot];
    }
    /**
    ...
    {
        checkoutcomwc_vendor_trigger_deprecation('guzzlehttp/guzzle', '7.15', '%s() is deprecated and will be removed in 8.0. Use PHP\'s json_decode() instead.', __METHOD__);
        if ($depth < 1) {
    ...
    {
        checkoutcomwc_vendor_trigger_deprecation('guzzlehttp/guzzle', '7.15', '%s() is deprecated and will be removed in 8.0. Use PHP\'s json_encode() instead.', __METHOD__);
    ...
    public static function normalizeIdnConversionOption($value): ?int
    {
        ...
        if (\is_string($value) && \is_numeric($value) || \is_float($value) && \is_finite($value)) {
            checkoutcomwc_vendor_trigger_deprecation('guzzlehttp/guzzle', '7.11', 'Passing %s as the "idn_conversion" request option is deprecated; guzzlehttp/guzzle 8.0 will reject values that are not true, false, null, or an integer IDNA_* bitmask.', \get_debug_type($value));
            return (int) $value;
        }
