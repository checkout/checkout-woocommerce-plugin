...
$deleted = WC_Checkout_Pci_Customer_Card::removeCustomerCard($customerId, $cardId);

if ($deleted) {
    $result['status']   = 'ok';
    $result['message']  = WC_Checkout_Pci_Customer_Card::getCustomerCardListHtml($customerId);
}
